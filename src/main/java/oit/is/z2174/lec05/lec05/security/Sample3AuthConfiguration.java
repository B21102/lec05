package oit.is.z2174.lec05.lec05.security;
...
public class Sample3AuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails customer1 = User.withUsername("customer1")
        .password("{bcrypt}$2y$10$I56Nl2VtLYyyAufCKZk8KuyR9.RmJwX5XgYXjLdLPpZ6jx/Bnp3jC")
        .roles("CUSTOMER")
        .build();
    // $ sshrun htpasswd -nbBC 10 customer2 p@ss
    UserDetails customer2 = User.withUsername("customer2")
        .password("{bcrypt}$2y$10$AfkMbUHcO358ebBVAnPg/eFFEM3d4Ku8qeretpFJ.TOKsOSeR3z9q")
        .roles("CUSTOMER")
        .build();
    // $ sshrun htpasswd -nbBC 10 seller p@ss
    UserDetails seller = User.withUsername("seller")
        .password("{bcrypt}$2y$10$xPBwqptVr0BMaDVm8IgItuRyEZtouaLgf4rxdRXtnGrxCl8ki8r1S")
        .roles("SELLER")
        .build();
